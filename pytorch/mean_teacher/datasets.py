...
class NECDatasetCTX(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform is not None:
            ...
            if NECDatasetCTX.WORD_NOISE_TYPE == 'replace' or NECDatasetCTX.WORD_NOISE_TYPE == 'replace_idf' or NECDatasetCTX.WORD_NOISE_TYPE == 'replace_idf_rev' or NECDatasetCTX.WORD_NOISE_TYPE == 'replace_ant':
...
class NECDataset(Dataset):
    ...
    def __init__(self, dir, args, transform=None):
        ...
        w2vfile = dir + "/../../vectors.goldbergdeps.txt"   # REVERTING .. "/../../glove.840B.300d.txt"# NOTE: replacing with GLoVE
